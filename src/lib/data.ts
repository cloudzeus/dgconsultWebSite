...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    solution: "Υλοποιήσαμε μια λύση όπου κάθε παρτίδα πρώτης ύλης λαμβάνει μια μοναδική ψηφιακή ταυτότική. Όλη η διαδρομή καταγράφεται σε αμετάβλητο καθολικό (ledger), προσβάσιμο μέσω QR codes στις συσκευασίες.",
